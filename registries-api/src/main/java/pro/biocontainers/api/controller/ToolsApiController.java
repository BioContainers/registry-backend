...
@Controller
@RequestMapping("${registry.api.base-path}/tools")
public class ToolsApiController {
     ...
     */
    @RequestMapping(value = "/{id}/versions/{version_id}",
            produces = {"application/json", "text/plain"},
            method = RequestMethod.GET)
     ...
     */
    @RequestMapping(value = "/{id}/versions/{version_id}/containerfile",
            produces = {"application/json", "text/plain"},
            method = RequestMethod.GET)
     ...
     */
    @RequestMapping(value = "/{id}/versions/{version_id}/{type}/descriptor",
            produces = {"application/json", "text/plain"},
            method = RequestMethod.GET)
     ...
     * @return The tool descriptor.
     */
    @RequestMapping(value = "/{id}/versions/{version_id}/{type}/descriptor/{relative_path}",
            produces = {"application/json", "text/plain"},
            method = RequestMethod.GET)
     ...
     */
    @RequestMapping(value = "/{id}/versions/{version_id}/{type}/files",
            produces = {"application/json", "text/plain"},
            method = RequestMethod.GET)
     ...
     */
    @RequestMapping(value = "/{id}/versions/{version_id}/{type}/tests",
            produces = {"application/json", "text/plain"},
            method = RequestMethod.GET)
